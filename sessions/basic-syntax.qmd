...
Please **type**, yes **type** the following arithmetic operations into the console, then press enter to execute the code and observe the results. Focus to type is to develop muscles memory.
```{r}
# Subtraction
10 - 6  # Output: 4
```
